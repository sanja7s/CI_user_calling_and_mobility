...
#######################################################################################      
# this is where we regroup total and avg traj per subpref
####################################################################################### 

########################################################
# 1 read in user total traj
########################################################
def read_in_user_stats1():
...
########################################################
# 2 read in user total traj
########################################################
def read_in_user_stats2():
...
########################################################
# divide and save user total traj per SUBPREF
########################################################
def save_stats_per_subpref1():
    
    location = "/home/sscepano/Project7s/D4D/CI/user_stats/Traj/perSUBPREF"
    
    user_home = read_in_user_home()
    user_stat = read_in_user_stats1()
    
    f = defaultdict()
    for i in range (256):
        file_name = "traj_SUBPREF_" + str(i) + ".tsv"
...
########################################################
# divide and save user avg daily traj per SUBPREF
########################################################
def save_stats_per_subpref2():
    
    location = "/home/sscepano/Project7s/D4D/CI/user_stats/Traj/perSUBPREF"
    
    user_home = read_in_user_home()
    user_stat = read_in_user_stats2()
    
    f = defaultdict()
    for i in range (256):
        file_name = "avg_daily_traj_SUBPREF_" + str(i) + ".tsv"
        save_path = join(location,file_name)
        f[i] = open(save_path, "w")
...
########################################################
# divide and save user total traj per POLE
########################################################
def save_stats_per_pole1():
    
    location = "/home/sscepano/Project7s/D4D/CI/user_stats/Traj/perPOLE"
    ...
    f = defaultdict()
    for i in range (12):
        file_name = "traj_POLE_" + str(i) + ".tsv"
        save_path = join(location,file_name)
        f[i] = open(save_path, "w")
...
########################################################
# 2 divide and save user avg daily traj per POLE
########################################################
def save_stats_per_pole2():
    ...
    f = defaultdict()
    for i in range (12):
        file_name = "avg_daily_traj_POLE_" + str(i) + ".tsv"
        save_path = join(location,file_name)
        f[i] = open(save_path, "w")
...
# save_stats_per_subpref1()
# save_stats_per_pole1()

save_stats_per_subpref2()
save_stats_per_pole2()